...
import { PasswordReset, PasswordResetSchema } from './schemas/password_reset.schemas';

@Module({
  imports: [
          MongooseModule.forFeature([{ name: PasswordReset.name, schema: PasswordResetSchema, collection: 'password_resets' }])
        ],
