...
import { VerificationToken,TokenSchema } from './schemas/verification_token.schema';

@Module({
  imports: [
        MongooseModule.forFeature([{ name: VerificationToken.name, schema: TokenSchema, collection: 'verification_tokens' }])
      ],
