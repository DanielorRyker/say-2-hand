        ...
        <div className={styleLogin['container']}>
            <div className={styleLogin['card']}>
              ...
              <div className={styleLogin['gradientBorder']} >
                ...
                <div>
                     <button className={styleLogin['btnLogin']}   ><p style={{fontSize: '28px',fontWeight: 'bold',}}>Đăng nhập</p></button>
                </div>
                ...
                <div style={{display:'flex'}}>
                    ...
                    <Link href="/auth/register" style={{fontWeight:'bold',fontSize:18, color:'#3B82F6'}}> Đăng ký tài khoản mới</Link>
                </div>
