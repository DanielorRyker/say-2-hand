        ...
        <div className={stylePost["card"]}>
              ...
              <div>
                ...
                <label htmlFor="upload-avatar">
                  <img
                    src={preview}
                    alt="preview"
                    className={stylePost["avatarImgNew"]}
                  />
                </label>
              </div>
            ) : (
          ...
          <div className={stylePost["cardRight"]}>
            <div className={stylePost["gradientBorderInfo"]}>
              <label
                htmlFor="category"
                className={stylePost["labelInfoDetail"]}
              >
                Danh mục sản phẩm
              </label>
              <select
            ...
            <div className={stylePost["groupInfo"]}>
              <label htmlFor="" className={stylePost["labelInfoDetail"]}>
                Thông tin chi tiết
              </label>
              ...
              >
                ...
                <div className={stylePost["gradientBorderCondition"]}>
                  <button className={stylePost["btnCondition"]}>
                    Đã sử dụng
                  </button>
                </div>
                <div className={stylePost["gradientBorderCondition"]}>
